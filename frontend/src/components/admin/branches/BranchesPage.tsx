  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
        {[
          ["3", "Total Branches", "Active store locations"],
          ["3", "Pickup Available", "All branches offer pickup"],
          ["9", "Active Staff", "Assigned across branches"],
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <Info label="Assigned Staff" value={`${branch.staff} Staff`} />
              ...
              <footer className="mt-6 flex flex-col gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <span className="flex gap-4">
                  <button className="min-h-10 rounded-lg bg-orange-500 px-4 text-sm font-semibold text-white">
                    Edit Branch
                  </button>
