        ...
        <>
            ...
            <div className="about-content">
                ...
                <p>
                    ...
                    business also supports riders through motorcycle maintenance,
                    repair services, store pickup, and convenient Lalamove delivery
                    requests.
                </p>
                <p>
                    The goal of ALD Motorshop is to make dependable motorcycle parts
                    easier to find while giving customers helpful service and
                    convenient ways to receive their orders.
                </p>
                </div>
