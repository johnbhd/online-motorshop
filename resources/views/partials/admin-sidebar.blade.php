@php
    $adminNavigationItems = [
        ...
        ['label' => 'Pickup Requests', 'route' => 'admin.pickup-requests.index', 'active' => 'admin.pickup-requests.*', 'icon' => 'fa-solid fa-store'],
        ['label' => 'Delivery Requests', 'route' => 'admin.delivery-requests.index', 'active' => 'admin.delivery-requests.*', 'icon' => 'fa-solid fa-motorcycle'],
