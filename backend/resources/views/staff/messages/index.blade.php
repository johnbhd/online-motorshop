...
@section('content')
    <div
        class="space-y-5"
        data-staff-messages
        data-messages-endpoint="{{ route('staff.messages.data') }}"
    >
        <section
        ...
        >
            <div>
                ...
                <p class="mt-2 text-sm text-slate-600 sm:text-base">
                    Reply to customer questions and assist customers with their motorcycle parts orders.
                </p>
            </div>
        ...
        >
            <div
                class="flex h-[calc(100vh-17rem)] min-h-[38rem] flex-col gap-3 p-3 lg:flex-row"
            >
                <aside
                ...
                >
                    <div class="flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-slate-200">
                        <div
                            class="flex items-center gap-3 border-b border-slate-200 px-5 py-4 sm:px-6"
                        >
                            <button
                                type="button"
